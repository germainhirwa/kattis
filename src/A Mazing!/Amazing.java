...
public class Amazing {
    static Set<Integer> exploredSet = new HashSet<Integer>();           // set to contain the explored directed edges
    ...
    public static void DFS (int i, int j, int dir) throws IOException {
        for (int m = 1; m <= 4; m++) {
            ...
            if (!exploredSet.contains(hash(i,j,k))) {
                exploredSet.add(hash(i,j,k));               // Add edge to explored set
